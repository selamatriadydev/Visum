...
function tambah($conn){
    ...
    if (isset($_POST['btn_simpan'])){
        $nm_jenispemeriksaanluar = $_POST['nm_jenispemeriksaanluar'];
        if(!empty($nm_jenispemeriksaanluar)){
            $sql = "INSERT INTO jenispemeriksaanluar (nm_jenispemeriksaanluar) VALUES('".$nm_jenispemeriksaanluar."')";
        ...
        <form action="" method="POST">
            <fieldset>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nm_jenispemeriksaanluar" id="inputEmail3" placeholder="Nama" required="required">
                  </div>
                </div>
                <br>
                <br>
...
function tampil_data($conn){
    $sql = "SELECT * FROM jenispemeriksaanluar";
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo $thisURL; ?>&aksi=update&id=<?php echo $data['id_jenispemeriksaanluar']; ?>&nm=<?php echo $data['nm_jenispemeriksaanluar']; ?>" class="btn btn-primary">Ubah</a> |
                    <a href="<?php echo $thisURL; ?>&aksi=delete&id=<?php echo $data['id_jenispemeriksaanluar']; ?>" class="btn btn-danger">Hapus</a>
                </td>
            </tr>
        <?php
   $no++; }
...
function ubah($conn){
    ...
    if(isset($_POST['btn_ubah'])){
        ...
        if(!empty($id) && !empty($nm_jenispemeriksaanluar) ){
            $perubahan = "nm_jenispemeriksaanluar='".$nm_jenispemeriksaanluar."'";
            $sql_update = "UPDATE jenispemeriksaanluar SET ".$perubahan." WHERE id_jenispemeriksaanluar=$id";
    ...
    if(isset($_GET['id'])){
        ...
        ?>
            ...
            <hr>
            <form action="" method="POST">
            <input type="hidden" name="id_jenispemeriksaanluar" value="<?php echo $_GET['id'] ?>"/>
            <fieldset>
               ...
               <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nm_jenispemeriksaanluar" id="inputEmail3" placeholder="Nama" required="required" value="<?php echo $_GET['nm']; ?>">
                  </div>
                </div>
                <br><br>
