...
function tambah($conn){
    ...
    if (isset($_POST['btn_simpan'])){
        ...
        if(!empty($nm_kota)){
            $sql = "INSERT INTO kota (nm_kota) VALUES('".$nm_kota."')";
        ...
        <form action="" method="POST">
            <fieldset>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nm_kota" id="inputEmail3" placeholder="Nama" required="required">
                  </div>
                </div>
                <br>
                <br>
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo $thisURL; ?>&aksi=update&id=<?php echo $data['id_kota']; ?>&nm=<?php echo $data['nm_kota']; ?>" class="btn btn-primary">Ubah</a> |
                    <a href="<?php echo $thisURL; ?>&aksi=delete&id=<?php echo $data['id_kota']; ?>" class="btn btn-danger">Hapus</a>
                </td>
            </tr>
        <?php
   $no++; }
...
function ubah($conn){
    ...
    if(isset($_POST['btn_ubah'])){
        ...
        if(!empty($id) && !empty($nm_kota) ){
            $perubahan = "nm_kota='".$nm_kota."'";
            $sql_update = "UPDATE kota SET ".$perubahan." WHERE id_kota=$id";
    ...
    if(isset($_GET['id'])){
        ...
        ?>
            ...
            <hr>
            <form action="" method="POST">
            <input type="hidden" name="id_kota" value="<?php echo $_GET['id'] ?>"/>
            <fieldset>
               ...
               <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nm_kota" id="inputEmail3" placeholder="Nama" required="required" value="<?php echo $_GET['nm']; ?>">
                  </div>
                </div>
                <br><br>
...
function hapus($conn){
    if(isset($_GET['id']) && isset($_GET['aksi'])){
        $thisURL="vs.php?page=".$_GET['page']."";
        $id = $_GET['id'];
        $sql_hapus = "DELETE FROM kota WHERE id_kota=" . $id;
