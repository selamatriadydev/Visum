...
<div class="box box-info">
              <div class="box-body">
<?php
$query=mysqli_query($conn, "SELECT * FROM pemeriksaan, korban, pemeriksa, penyidik WHERE pemeriksaan.id_pemeriksaan=".$_GET['vshmy']." AND pemeriksaan.id_korban=korban.id_korban AND pemeriksaan.id_pemeriksa=pemeriksa.id_pemeriksa AND pemeriksaan.id_penyidik=penyidik.id_penyidik");
